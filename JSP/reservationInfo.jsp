...
<div class="row" data-reactid="9">
   ...
   <!-- react-text: 18 -->Check out (ex 2021.06.01)<!-- /react-text -->
    ...
    <div data-reactid="206">
                  ...
                  <div class="clearfix form-row booking-last" data-reactid="308">
                      <a class="ladda-button booking-btn" onclick="location.href='reservationModify.jsp?num=<%=rDo.getNum()%>'" role="button" data-reactid="309">
                          <span class="ladda-label" data-reactid="310">수정하기</span>
                      </a>
                  </div>
                  <div class="clearfix form-row booking-last" data-reactid="308">
